...
move_uploaded_file($_FILES["evfile"]["tmp_name"],"complaintdocs/".$_FILES["evfile"]["name"]);

$query=mysqli_query($con,"insert into tblsubadminremark(ComplainNumber,ComplainStatus, evFile ,ComplainRemark,RemarkBy) values('$complaintnumber','$state', '$evfile' , $remark','$sadminid')");
$sql=mysqli_query($con,"update tblcomplaints set state='$state' where complaintNumber='$complaintnumber'");

echo "<script>alert('Complaint details updated successfully');</script>";
if($state == 'closed'){
 echo "<script>alert('Complaint details updatedddd');</script>";   
