...
<?php
    if(isset($_GET['token'])) {
        ...
        $verifyQuery = mysqli_query($connect,"SELECT * FROM admin WHERE token = '$token'");
        ...
        if(isset($_POST['reset'])) {
            ...
            $changeQuery = mysqli_query($connect,"UPDATE admin SET password = '$new_password' WHERE EmailId = '$email' and token = '$token'");
