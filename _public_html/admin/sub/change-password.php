...
{
$sql=mysqli_query($con,"SELECT Password FROM  tblsubadmin where Password='".($_POST['password'])."' && UserName='".$_SESSION['subalogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update tblsubadmin set Password='".($_POST['newpassword'])."' where UserName='".$_SESSION['subalogin']."'");
