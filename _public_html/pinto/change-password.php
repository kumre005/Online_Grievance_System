...
{
$sql=mysqli_query($con,"SELECT password FROM  Principal where password='".($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update Principal set password='".($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
