...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".($_POST['password'])."' && username='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update users set password='".($_POST['newpassword'])."'where username='".$_SESSION['login']."'");
